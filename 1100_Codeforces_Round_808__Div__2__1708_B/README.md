...
YES
1000000000
</pre></div></div></div><div class="note"><div class="section-title">Note</div><p>In the first test case, $$$\gcd(1,a_1),\gcd(2,a_2),\ldots,\gcd(5,a_5)$$$ are equal to $$$1$$$, $$$2$$$, $$$3$$$, $$$4$$$, $$$5$$$, respectively.</p></div></div>

---
**Problem Name:** Difference of GCDs <br>
**Tags:** constructive algorithms, math <br>
