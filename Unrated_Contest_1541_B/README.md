...
1
3
</pre></div></div></div><div class="note"><div class="section-title">Note</div><p>For the first test case, the only pair that satisfies the constraints is $$$(1, 2)$$$, as $$$a_1 \cdot a_2 = 1 + 2 = 3$$$</p><p>For the second test case, the only pair that satisfies the constraints is $$$(2, 3)$$$.</p><p>For the third test case, the pairs that satisfy the constraints are $$$(1, 2)$$$, $$$(1, 5)$$$, and $$$(2, 3)$$$.</p></div></div>

---
**Problem Name:** Pleasant Pairs <br>
**Tags:**  <br>
